    ...
    <section class="single-bath-page">
      <div class="wrapper">
        <div class="single-bath-page-inner">
          <h3 class="page__title-h3 page__title page_regular">Жилой комплекс с баней №</h3>
          <div class="single-bath-page-img">
            <div class="single-bath-page__img"> <img src="assets/images/png/archive-bath/single-bath-page-img-1.png"
                alt=""></div>
          ...
          <div class="single-bath-page-description">
            ...
            <div class="page__text">В лесной части клуба уютно расположились коттеджные домики с гостиничными номерами.
              <br> <br> Один коттедж состоит из двух или трех двухместных номеров с отдельными входами и индивидуальными
              меблированными верандами.
              <br> <br> В номерах есть все необходимое для комфортного загородного отдыха, а также доступно
              круглосуточное комплексное обслуживание по меню блюд и услуг яхт-клуба “Адмирал”.
            </div>
          </div>
          <div class="single-bath-page-more-order">
            ...
            <div class="single-bath-page-more-order__items">
              <div class="single-bath-page-more-order__item">
                ...
                <div class="single-bath-page-more-order__item-img"> <img
                    src="assets/images/png/archive-bath/single-bath-page-more-order-img-2.png" alt=""></div>
                <div class="single-bath-page-more-order__item-link"><a class="page-link page-link_arrow"
                    href="">Посмотреть меню<div class="svg-cheveron-right svg-cheveron-right-box"></div></a></div>
              </div>
              <div class="single-bath-page-more-order__item">
                ...
                <div class="single-bath-page-more-order__item-img"> <img
                    src="assets/images/png/archive-bath/single-bath-page-more-order-img-1.png" alt=""></div>
                <div class="single-bath-page-more-order__item-link"><a class="page-link page-link_arrow"
                    href="">Посмотреть впечатления<div class="svg-cheveron-right svg-cheveron-right-box"></div></a>
                </div>
              </div>
            </div>
          </div>
