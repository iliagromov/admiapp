...
<main class="page">
    <section class="banner banner-impressions">
      <div class="banner_bg">
        <div class="banner_bg-shadow"></div><img src="assets/images/png/impressions/img-impressions.png" alt="banner">
      </div>
      <div class="wrapper">
        <div class="banner-inner banner-inner_center">
          <div class="banner__title_left">
            <h1 class="page__title page_regular page__title-h1">Широкий спектр летних впечатлений</h1>
            <p class="page__text">Водные виды спорта — отличный способ подвигаться, весело провести время и насладиться
              отдыхом на свежем воздухе</p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="tabs" id="tabs">
            ...
            <div class="tab-content is-active">
              <div class="images-menu-items"><a class="images-menu__item" href="">
                  <div class="images-menu__item-img"><img src="assets/images/png/impressions/img-impressions-1.png"
                      alt="impressions"></div>
                  ...
                  <div class="images-menu__item-img"><img src="assets/images/png/impressions/img-impressions-2.png"
                      alt="impressions"></div>
                  <div class="images-menu__item-text">
                    <h4 class="page__title page_regular page__title-h4">Катание на гидроцикле</h4>
                  </div>
                </a><a class="images-menu__item" href="">
                  <div class="images-menu__item-img"><img src="assets/images/png/impressions/img-impressions-3.png"
                      alt="impressions"></div>
                  <div class="images-menu__item-text">
                    <h4 class="page__title page_regular page__title-h4">Рыбалка</h4>
                  </div>
                </a><a class="images-menu__item" href="">
                  <div class="images-menu__item-img"><img src="assets/images/png/impressions/img-impressions-4.png"
                      alt="impressions"></div>
                  <div class="images-menu__item-text">
                    <h4 class="page__title page_regular page__title-h4">Сапсерфинг</h4>
                  </div>
                </a><a class="images-menu__item" href="">
                  <div class="images-menu__item-img"><img src="assets/images/png/impressions/img-impressions-5.png"
                      alt="impressions"></div>
                  <div class="images-menu__item-text">
                    <h4 class="page__title page_regular page__title-h4">Прокат лодок</h4>
                  </div>
                </a><a class="images-menu__item" href="">
                  <div class="images-menu__item-img"><img src="assets/images/png/impressions/img-impressions-6.png"
                      alt="impressions"></div>
                  <div class="images-menu__item-text">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide slider-banner-slide">
          ...
          <div class="slider-banner-slide__img">
            <div class="slider-banner-slide__img_bg"></div><img src="assets/images/png/main-page/banner-sport.png"
              alt="banner-spa">
          </div>
        </div>
        <div class="swiper-slide slider-banner-slide">
          ...
          <div class="slider-banner-slide__img">
            <div class="slider-banner-slide__img_bg"></div><img src="assets/images/png/main-page/banner-menu.png"
              alt="banner-spa">
          </div>
        </div>
        <div class="swiper-slide slider-banner-slide">
          ...
          <div class="slider-banner-slide__img">
            <div class="slider-banner-slide__img_bg"></div><img src="assets/images/png/main-page/banner-spa.png"
              alt="banner-spa">
          </div>
        </div>
      </div>
