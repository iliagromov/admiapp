...
<main class="page">
	...
	<?php include(TEMPLATEPATH . "/src/components/_banner/_banner-impressions-winter.php"); ?>
      ...
      <div class="impressions-menu-inner">
        <div class="tabs" >
          ...
          <div class="tav-nav">
            ...
            <a class="tab-link" href="/admiral/impressions-summer">
              <div class="page-link">Летние развлечения</div>
            </a>
            <a class="tab-link is-active"   href="/admiral/impressions-winter">
