...
идея
Можно ли не дублировать папку src ? 
Хочу сделать так, что я сразу писал в php файле и обрабатывал поля по условию, если поля нет, то я подставляю статику
Вотч идет по php файлам также в папке есть sass