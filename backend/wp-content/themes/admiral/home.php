  ...
  <main class="page">
    ...
    <section class="info-block">
      ...
      <div class="info-block__img"> <img src="assets/images/png/main-page/banner-admiral@2x.png" alt="banner-admiral">
        <div class="info-block__link-show-more"><a class="page-link page-link_arrow" href="/">Больше программ<div
              class="svg-cheveron-right svg-cheveron-right-box"></div></a></div>
      </div>
    </section>
    <section class="info-block-certificates">info-block-certificates</section>
